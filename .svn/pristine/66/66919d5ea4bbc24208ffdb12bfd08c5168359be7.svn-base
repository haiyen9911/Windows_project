...
namespace QuanLyQuanMi
{
    public partial class fnhaphang : Form
    {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e) // Lấy tên nhân viên theo ID
        {
            try
            {
        ...
        private void textBox5_TextChanged(object sender, EventArgs e) // Load chi tiết phiếu nhập theo phiếu nhập
        {
            if (textBox5.Text.Equals(""))
            {
                int temp = PhieuNhapDAO.Instance.GetMaxId();
        ...
        private void textBox4_TextChanged(object sender, EventArgs e) // Lấy tên sản phẩm theo mã sản phẩm
        {
            try
            {
